...
int mp3dec_frame_size(mp3dec_t *dec, const uint8_t *mp3)
{
    return hdr_frame_bytes(mp3, dec->free_format_bytes) + hdr_padding(mp3);
}

#define scratch (dec->_scratch) // get it off the stack
int mp3dec_decode_frame(mp3dec_t *dec, const uint8_t *mp3, int mp3_bytes, mp3d_sample_t *pcm, mp3dec_frame_info_t *info)
{
